...
import Avatar from "@mui/material/Avatar"; // For the profile image
import { ListItem, ListItemButton, ListItemText, Popover } from "@mui/material"; // For the logout menu
import Logout from "../../Auth/Logout"; // For the logout functionality
